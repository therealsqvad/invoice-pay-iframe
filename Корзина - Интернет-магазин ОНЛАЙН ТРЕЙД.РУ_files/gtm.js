...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"google_conversion_value"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "vtp_defaultValue":"RUB",
      "vtp_name":"google_conversion_currency"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
  ...
  "tags":[{
      "function":"__sp",
      "once_per_event":true,
      "vtp_customParams":["list",["map","key","productId","value",["macro",1]],["map","key","ecomm_pagetype","value","product"],["map","key","ecomm_prodid","value",["macro",1]]],
      "vtp_conversionId":"1064308867",
      ...
      "vtp_webPropertyId":"UA-24629835-1",
      ...
      "vtp_conversionLabel":"N8miCOiYl3wQg6HA-wM",
      "vtp_url":["macro",2],
...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.s[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.w="GTM-MM9DKDW";Vc.Kb="432";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.cdn";var $c=Zc,ad=null,bd=null,cd=null,dd="//www.googletagmanager.com/a?id="+Vc.w+"&cv=30",ed={},fd={},gd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var hd={},jd=function(a,b){hd[a]=hd[a]||[];hd[a][b]=!0},kd=function(a){for(var b=[],c=hd[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
ic(r+"/gtag/cdn?id="+p+"&l=dataLayer&cx=c")}}this.h.push(new Ri(a,e,c,b,d));d||this.flush()};
...
var gj={config:function(a){},event:function(a){var b=a[1];if(g(b)&&!(3<a.length)){var c;if(2<a.length){if(!Pa(a[2])&&void 0!=a[2])return;c=a[2]}var d=aj(b,c);return d}},js:function(a){if(2==a.length&&a[1].getTime)return{event:"gtm.cdn","gtm.start":a[1].getTime()}},policy:function(){},set:function(a){var b;2==a.length&&Pa(a[1])?b=D(a[1]):3==a.length&&
...
b);return F[a]},Ik=function(a,b,c){return Yf(a,b,void 0===c?!0:!!c)},Jk=function(a,b){if(Wd()){b&&I(b)}else kc(a,b)},Kk=function(a){return!!Yj(a,"init",!1)},Lk=function(a){Wj(a,"init",!0)},Mk=function(a,b){var c=(void 0===b?0:b)?"www.googletagmanager.com/gtag/cdn":$c;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";S(Q("https://","http://",c))},Nk=function(a,b){var c=a[b];return c};
...
Z.a.sp=["google"],function(){(function(a){Z.__sp=a;Z.__sp.b="sp";Z.__sp.g=!0;Z.__sp.priorityOverride=0})(function(a){var b=-1==navigator.userAgent.toLowerCase().indexOf("firefox")?"//www.googleadservices.com/pagead/conversion_async.cdn":"https://www.google.com/pagead/conversion_async.js",c=a.vtp_gtmOnFailure;Je();S(b,function(){var d=X("google_trackConversion");if(qa(d)){var e=
...
y=function(O){var M=[].slice.call(arguments,0);M[0]=q+M[0];u.apply(window,M)},x=function(O,M){return void 0===M?M:O(M)},A=function(O,M){if(M)for(var ua in M)M.hasOwnProperty(ua)&&y("set",O+ua,M[ua])},B=function(){var O=function(gn,tj,hn){if(!Pa(tj))return!1;for(var id=Fa(Object(tj),hn,[]),qg=0;id&&qg<id.length;qg++)y(gn,id[qg]);return!!id&&0<id.length},M;if(d.vtp_useEcommerceDataLayer){var ua=!1;ua||(M=W("ecommerce",1))}else d.vtp_ecommerceMacroData&&(M=d.vtp_ecommerceMacroData.ecommerce);if(!Pa(M))return;M=Object(M);var Ob=Fa(f,"currencyCode",M.currencyCode);void 0!==Ob&&y("set","&cu",Ob);O("ec:addImpression",M,"impressions");if(O("ec:addPromo",M[M.promoClick?"promoClick":"promoView"],"promotions")&&M.promoClick){y("ec:setAction","promo_click",M.promoClick.actionField);return}for(var Ea="detail checkout checkout_option click add remove purchase refund".split(" "),
ab="refund purchase remove checkout checkout_option add click detail".split(" "),bb=0;bb<Ea.length;bb++){var nb=M[Ea[bb]];if(nb){O("ec:addProduct",nb,"products");y("ec:setAction",Ea[bb],nb.actionField);if(Cd)for(var Ab=0;Ab<ab.length;Ab++){var Ac=M[ab[Ab]];if(Ac){Ac!==nb&&jd("GTM",13);break}}break}}},z=function(O,M,ua){var Ob=0;if(O)for(var Ea in O)if(O.hasOwnProperty(Ea)&&(ua&&v[Ea]||!ua&&void 0===v[Ea])){var ab=w[Ea]?Aa(O[Ea]):
...
d.vtp_useDebugVersion?"u/analytics_debug.cdn":"analytics.cdn";d.vtp_useInternalVersion&&!d.vtp_useDebugVersion&&(va="internal/"+va);a=!0;var cb=Q("https:","http:","//www.google-analytics.com/"+va,f&&f.forceSSL);S(cb,function(){var O=Oe();O&&O.loaded||d.vtp_gtmOnFailure();},d.vtp_gtmOnFailure)}}else I(d.vtp_gtmOnFailure)};
...
Z.a.ga=["google"],function(){var a,b,c=function(d){function e(L){var N=[].slice.call(arguments,0);N[0]=v+N[0];q.push(N)}function f(L,N){void 0!==d[N]&&e(L,d[N])}function h(L,N){void 0!==d[N]&&e(L,Number(d[N]))}function k(L,N){if(u(N))for(var P=0;P<N.length;P++)e(L,N[P])}function l(L,N,P){if(u(N))for(var T=0;T<N.length;T++){for(var na=[L],ia=N[T],va=0;va<P.length;va++)na.push(ia[P[va]]);e.apply(this,na)}}function m(L,N){void 0!==d[N]&&e("_set",L,d[N])}function p(L,N){return void 0===N?N:L(N)}function r(L,
N){void 0!==N&&(w+="&"+L+"="+N)}var u=sa,q=X("_gaq",[],!1),t=!1,v="";void 0==d.vtp_trackerName?v="gtm"+gd()+".":""!==d.vtp_trackerName&&(v=d.vtp_trackerName+".");f("_setAccount","vtp_webPropertyId");e("_set","gtmid",rh(!0));
...
if(""!==w){var y=function(L,N,P){for(var T=N.length-1;0<=T;T--){var na=N[T].split("=");if(na[0]===L)return na[1]||"1"}for(var ia=P.length-1;0<=ia;ia--){var va=P[ia].split("=");if(va[0]===L)return va[1]||"1"}},x=af(Dk()),A=$e(x,"query").split("&"),B=d.vtp_allowAnchor?$e(x,"fragment").split("&"):[];r("gclid",y("gclid",B,A));r("gclsrc",y("gclsrc",B,A));r("dclid",y("dclid",B,A));e("_set","campaignParams",w)}m("anonymizeIp","vtp_anonymizeIp");
d.vtp_enableInPageLinkId&&e("_require","inpage_linkid","//www.google-analytics.com/plugins/ga/inpage_linkid.cdn");f("_setCampaignTrack",
...
var la=function(){X("_gat")||d.vtp_gtmOnFailure()};if(d.vtp_doubleClick)b||(b=!0,S(Q("https","http","://stats.g.doubleclick.net/dc.cdn",t),la,d.vtp_gtmOnFailure));else if(!a){var U=d.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.cdn":".google-analytics.com/ga.cdn";a=!0;S(Q("https://ssl","http://www",U,t),la,d.vtp_gtmOnFailure)}};Z.__ga=c;Z.__ga.b="ga";Z.__ga.g=!0;Z.__ga.priorityOverride=0}();
...
l.google_additional_conversion_params||{})[v]=w},u=function(v){return function(w,y,x,A){var B="DATA_LAYER"==v?W(x):k[y];A(B)&&r(w,B)}},q=-1==navigator.userAgent.toLowerCase().indexOf("firefox")?"//www.googleadservices.com/pagead/conversion_async.cdn":"https://www.google.com/pagead/conversion_async.js";k.vtp_enableNewCustomerReporting&&(p=u(k.vtp_newCustomerReportingDataSource),p("vdnc","vtp_awNewCustomer","new_customer",function(v){return void 0!=v&&""!==v}),p("vdltv","vtp_awCustomerLTV","customer_lifetime_value",
